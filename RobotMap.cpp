...
void RobotMap::init() {
    ...
    shooterMotor = new CANJaguar(4, CANJaguar::kSpeed);
	lightEncoder= new Encoder(1, 3, 1, 4, false, Encoder::k1X);
	lw->AddSensor("Shooter", "lightEncoder", lightEncoder);
		lightEncoder->SetDistancePerPulse(1.0);
		lightEncoder->SetPIDSourceParameter(Encoder::kRate);
		lightEncoder->Start();
