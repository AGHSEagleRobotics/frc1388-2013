...
OI::OI() {
	...
	prStick = new Joystick(4);
	killSwitch = new JoystickButton(prStick, 1);
	climberToggle = new JoystickButton(prStick, 2);
	speedToggle = new JoystickButton(prStick, 3);
	speedToggle->WhenPressed(new ());
