...
OI::OI() {
	...
	shooterRun = new JoystickButton(opStick, 6);
	shooterRun->WhenPressed(new RunShooter());
	shooterStop = new JoystickButton(opStick, 7);
	shooterStop->WhenPressed(new StopShooter());
	decreaseVoltage = new JoystickButton(opStick, 2);
	decreaseVoltage->WhenPressed(new VoltageDecrease());
	increaseVoltage = new JoystickButton(opStick, 3);
	...
	SmartDashboard::PutData("VoltageDecrease", new VoltageDecrease());
	SmartDashboard::PutData("VoltageIncrease", new VoltageIncrease());
	SmartDashboard::PutData("StopShooter", new StopShooter());
	SmartDashboard::PutData("RunDefaultVoltage", new RunDefaultVoltage());
